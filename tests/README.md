...
| `test_evidence_grades.py`  | Every `tml` tier-catalogue item carries a grade, every tier-A/B item also declares a quality exposure, both ladders match what `evidence-grades.md` documents, and every `A#`/`B#`/`C#`/`D#`/`P#` cross-reference resolves. |
